...
\acro{AVA}{Ambiente Virtual de Aprendizagem}
\acro{ARCS}{\textit{Attention, Relevance, Confidence, Satisfaction}}
...
\acro{CISO}{\textit{Chief Information Security Officer}}
\acro{CTF}{\textit{Capture The Flag}}
\acro{CTFs}{\textit{Capture The Flag}}
\acro{CSSL}{\textit{Cyber Sleuth Science Lab}}
...
\acro{ECSF}{\textit{European Cybersecurity Skills Framework}}
\acro{EDM}{\textit{Educational Data Mining}}
\acro{EAD}{Educação à Distância}
...
\acro{GBL}{Gamificação e Aprendizagem Baseada em Jogos}
\acro{GRC}{Governança, Risco e \textit{Compliance}}
...
\acro{IDLE}{\textit{Investigate and Decide Learning Environment}}
...
\acro{MOOCs}{\textit{Massive Open Online Courses} (Cursos Online Abertos e Massivos)}
\acro{myVOCS}{\textit{my Virtual Organization Collaboration System}}
\acro{MCTI}{Ministério da Ciência, Tecnologia e Inovação}
...
\acro{OSINT}{\textit{Open Source Intelligence}}
...
\acro{PICO}{População, Intervenção, Comparação e Outcome}
\acro{PRISMA}{\textit{Preferred Reporting Items for Systematic Reviews and Meta-Analyses}}
\acro{PMEs}{Pequenas e Médias Empresas}
\acro{PPI}{Programa Prioritário em Informática}
\acro{PBL}{\textit{Points, Badges, and Leaderboards}}
...
\acro{TCLE}{Termo de Consentimento Livre e Esclarecido}
