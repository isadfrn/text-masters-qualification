...
% ---
\titulo{Um \textit{Framework} de Diretrizes para ampliar o ingresso e a permanência de talentos femininos em Programas de Capacitação em Cibersegurança}
...
\titleenglish{A \textit{Framework} of Guidelines to increase the entry and retention of female talents in Cybersecurity training}
