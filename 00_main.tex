...
% ---
\titulo{Estratégias para Redução do Gap de Gênero em Cibersegurança: Diagnóstico e Diretrizes a partir da Análise do Programa Hackers do Bem}
...
%\numpaginas{175}
\palavraschave{educação em cibersegurança, gap de gênero, gamificação}
\keywords{cybersecurity education, gender gap, and gamification}
\englishmonth{January}
\titleenglish{Strategies for Reducing the Gender Gap in Cybersecurity: Diagnosis and Guidelines based on the Analysis of the Hackers do Bem Program}
...
\include{_template/lista_quadros}
%\include{_template/lista_siglas}
%\include{_template/lista_simbolos}
\include{frontmatter/lista_acronimos}
\include{frontmatter/sumario}
...
\include{chapters/02_cap2}
\include{chapters/03_cap3}
\include{chapters/04_cap4}
%\include{chapters/05_cap5}
...
%\include{appendices/20_apendiceA}
%\include{appendices/21_apendiceB}
%\include{appendices/22_apendiceC}
%\include{appendices/23_apendiceD}
%\include{appendices/24_apendiceE}
%\include{appendices/25_apendiceF}
%\include{appendices/26_apendiceG}
