...
\begin{quadro}[htb]
    ...
    \end{tabular}
    \end{footnotesize}
    \fonte{Elaborado pela autora com base em Basili et al. (1994) e na RSL.}
\end{quadro}
