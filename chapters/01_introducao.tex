...
\begin{itemize}
    ...
    \item Avaliar a correlação entre os mecanismos de gamificação (\ac{XP}, Ranking), outras estratégias de engajamento e o desempenho das participantes do programa.
